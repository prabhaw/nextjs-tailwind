  ...
  <div className='py-16 w-9/12 '>
    ...
    <div className='h-screen bg-gray-300'>
      <div className='flex items-center justify-center h-full'>
          ...
          <div class="md:w-1/2 hidden md:flex rounded-r">
          <img src="/images/loginbackground.jpg" alt="" class="w-full h-full rounded-l object-cover" />
        </div>
              <div className='bg-white w-full md:w-1/2 p-8 md:rounded-r rounded '>
                  <h1 className='text-gray-700 text-3xl text-center mb-4'>SIGN IN</h1>
                  <form className='text-gray-600'>
                      ...
                      <div className='my-6 flex'>
                          <button className='border rounded w-full py-2 border-blue-700 bg-blue-600 text-white ml-2'>SIGN IN</button>
                      </div>
